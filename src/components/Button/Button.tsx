...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "cursor-pointer rounded-sm px-4 py-1.5 font-medium tracking-wide uppercase transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50";
